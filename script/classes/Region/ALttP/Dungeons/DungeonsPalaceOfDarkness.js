  ...
  constructor(name = "Dungeons", subname = "PalaceOfDarkness") {
    ...
    if (this.buildLocations) {
      this.locations = new LocationCollection([
        ...
        new Location("Event", "Palace of Darkness - Boss", "97.0%", "40.0%", regionName, {equipment: "%%lantern%%"})
      ], this);
    }
  ...
  initNoMajorGlitches() {
    ...
    if (this.buildLocations) {
      ...
      this.locations["Palace of Darkness - Big Chest"].glitchless = function () {
        return has("lantern") && has("bigkeyd1") && (has("hammer") && canShootArrows()); // FIXME: Has key settings
      }
      ...
      this.locations["Palace of Darkness - Dark Basement - Right"].glitchless = function () {
        return torchCheck() && (has("hammer") && canShootArrows()); // FIXME: Has key settings
      }
    ...
    this.locations["Palace of Darkness - Boss"].glitchless = function () {
      return boss.canBeat() &&
        has("hammer") && has("lantern") && canShootArrows() &&
        has("bigkeyd1") && has("keyd1", 6);
    }
    ...
    this.canComplete.glitchless = function () {
      return dungeon.locations["Palace of Darkness - Boss"].glitchless();
    }
  }
