class OverworldShop extends Overworld {
  ...
  constructor(name = "Overworld", subname = "Shop") {
	...
	this.locations = new LocationCollection([
		...
		new Location("Shop","Unnamed Shop 1",					0/Z1FACTOR,		  0/Z1FACTOR,regionName),							// 0x12	// shop02
		new Location("Shop","Shop Just East of Bracelet Armos",	1440/Z1FACTOR,  368/Z1FACTOR,regionName),							// 0x25	// shop03
		new Location("Shop","Unnamed Shop 2",					0/Z1FACTOR,		  0/Z1FACTOR,regionName),							// 0x26	// shop04
		...
		new Location("Shop","Unnamed Shop 3",					0/Z1FACTOR,		  0/Z1FACTOR,regionName,{equipment:"%%candle%%"}),	// 0x46	// shop07
		new Location("Shop","Shop South of Desert",				2736/Z1FACTOR,  720/Z1FACTOR,regionName),							// 0x4A	// shop08
		new Location("Shop","Unnamed Shop 4",					0/Z1FACTOR,		  0/Z1FACTOR,regionName,{equipment:"%%candle%%"}),	// 0x4D	// shop09
		...
		new Location("Shop","Unnamed Shop 5",					0/Z1FACTOR,		  0/Z1FACTOR,regionName,{equipment:"%%candle%%"})	// 0x78	// shop13
	],this);
  }

  initNoMajorGlitches() {
	  this.locations["Unnamed Shop 3"].glitchless =
	  this.locations["Unnamed Shop 4"].glitchless =
