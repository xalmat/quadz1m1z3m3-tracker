class LightWorldNorthEast extends LightWorld {
  ...
  initNoMajorGlitches() {
	...
	this.locations["Zora's Ledge"].glitchless =
	this.locations["Waterfall Fairy - Left"].glitchless =
	this.locations["Waterfall Fairy - Right"].glitchless = function() {
		return canSwim();
	}
  ...
  initOverworldGlitches() {
	...
	this.locations["Zora's Ledge"].owglitches = function() {
		return canSwim()
			|| (canDash() && has("moonpearl"));
	}
	this.locations["Waterfall Fairy - Left"].owglitches =
	this.locations["Waterfall Fairy - Right"].owglitches = function() {
